          ...
          <div className="mb-4">
            ...
            <div className="flex items-center mb-2">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="convicted" className="text-gray-700">
                Convicted
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="notConvicted" className="text-gray-700">
                Not Convicted
              </label>
            </div>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center mb-4">
                <input
                  ...
                  className="mr-2"
                />
                <label htmlFor="rejected" className="text-gray-700">
                  Rejected
                </label>
              </div>
